			...
			<div class="ofc">
				...
				<form id="jvForm" action="profile.do" method="post">
					...
					<li>
						...
						<span class="word"><input type="radio" name="gender" value="MAN" <c:if test="${buyer.gender == 'SECRECY' }">checked="checked"</c:if>/>保密
					...
					</li><c:if test="${buyer.gender == SECRECY }">checked="checked"</c:if>
					<li>
